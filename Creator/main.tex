\documentclass[b5j, 9pt, nomag, dvipdfmx, papersize, twocolumn, uplatex]{jsarticle}
...
\newenvironment{enumwithcircle}{\begin{enumerate} \renewcommand{\labelenumi}{\textcircled{\scriptsize \theenumi}} }{\end{enumerate}}
\newenvironment{enumwithbox}{\begin{enumerate} \renewcommand{\labelenumi}{\(\Box \)(\theenumi)}}{\end{enumerate}}
...
\newcommand{\point}[1]{\vspace{0truemm} \noindent \hspace{-6truept}  ▶︎ \hspace{-4truept}\underline{\textbf{#1}}\\}
\newcommand{\checking}[1]{\vspace{0truemm} \noindent \hspace{-6truept}  ▷　#1}
